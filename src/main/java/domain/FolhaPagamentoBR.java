 ...
 */
public class FolhaPagamentoBR {
    private double salarioBruto;
    private double inss;
    private double irrf;
    private double salarioLiquido;

    public FolhaPagamentoBR(double salarioBruto) {
        this.salarioBruto = salarioBruto;
    }

    public FolhaPagamentoBR(double salarioBruto, double inss, double irrf, double salarioLiquido) {
        this.salarioBruto = salarioBruto;
        this.inss = inss;
        this.irrf = irrf;
